    ...
    <>
      ...
      <section className="py-96 bg-gradient-to-b from-black to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            className="space-y-4"
          >
            <p className="text-xl md:text-2xl font-light text-white leading-loose">
      ...
      <section className="relative overflow-hidden h-[100vh]">
        ...
        <div className="relative z-10 text-center text-black px-4 pt-28 md:pt-32 max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-6xl md:text-8xl font-extrabold leading-tight drop-shadow-sm">
              사람을 더 사람답게
            </h2>
            <p className="text-xl md:text-2xl font-light text-gray-700 leading-loose">
      ...
      <section className="py-[360px] bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="mb-20"
          >
            <h2 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">CORE VALUE</h2>
          </motion.div>
      ...
      {/* 브랜드 정신 강조 섹션 */}
      <section className="py-24 bg-[#f0bb00]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-10 leading-tight">'오럼'스럽다는 것</h2>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 max-w-4xl text-white">
          <p className="text-base md:text-lg text-gray-200 mb-6 leading-loose">
            오럼은, 황금처럼..<br />
